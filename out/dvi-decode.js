                    ...
                    if (psFileParams.length >= 1) {
                        ...
                        psFileParams.forEach((param) => {
                            ...
                            if (paramParts.length === 2) {
                                switch (paramParts[0]) {
                                    case 'llx':
                                        llxParam = Number.parseInt(paramParts[1]);
                                        break;
                                    case 'lly':
                                        llyParam = Number.parseInt(paramParts[1]);
                                        break;
                                    case 'urx':
                                        urxParam = Number.parseInt(paramParts[1]);
                                        break;
                                    case 'ury':
                                        uryParam = Number.parseInt(paramParts[1]);
                                        break;
                                    case 'rwi':
                                        rwiParam = Number.parseInt(paramParts[1]);
                                        break;
                                    case 'rhi':
                                        rhiParam = Number.parseInt(paramParts[1]);
                                        break;
                                }
                            }
                        });
